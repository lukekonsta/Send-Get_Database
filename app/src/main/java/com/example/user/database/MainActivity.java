...
public class MainActivity extends AppCompatActivity {
    ...
    String ServerURL = "http://192.168.10.9/android/insert.php" ;
    EditText name, email ;
    ...
    public void InsertData(final String name, final String email){
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                nameValuePairs.add(new BasicNameValuePair("ONE", NameHolder));
                nameValuePairs.add(new BasicNameValuePair("TWO", EmailHolder));
